...
public class AnswerController {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "OK",
                    content = @Content(schema = @Schema(implementation = ControllerApiResponse.class),
                            examples = @ExampleObject(value ="{\"success\":true,\"message\":\"조회 성공\",\"data\":{\"id\":9,\"title\":\"문의 사항 제목\",\"question_content\":\"문의 사항 내용\",\"status\":\"COMPLETED\",\"create_at\":\"2024-06-10T16:37:00\",\"answer_at\":\"2024-06-11T16:37:00\",\"member\":{\"id\":1,\"loginId\":\"user1234\"},\"answer\":{\"id\":3,\"answer_title\":\"답변 제목\",\"answer_content\":\"답변 내용\",\"answer_admin_nickname\":\"어드민사용자\"}}}"))),
            @ApiResponse(responseCode = "400",description = "BAD REQUEST",
                    content = @Content(schema = @Schema(implementation = ErrorResponse.class),
