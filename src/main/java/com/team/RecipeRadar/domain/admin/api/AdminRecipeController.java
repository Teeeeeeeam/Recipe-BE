...
import com.team.RecipeRadar.domain.admin.application.recipe.AdminRecipeService;
...
public class AdminRecipeController {
    ...
    @PostMapping(value = "/save/recipe", consumes= MediaType.MULTIPART_FORM_DATA_VALUE ,produces = MediaType.APPLICATION_JSON_VALUE)
    public ResponseEntity<?> recipe_save(@Valid @RequestPart RecipeSaveRequest recipeSaveRequest, BindingResult bindingResult,
        ...
        try {
            ...
            adminService.saveRecipe(recipeSaveRequest,uploadFile,originalFilename);
    ...
    @PutMapping(value = "/update/{recipe-id}",consumes= MediaType.MULTIPART_FORM_DATA_VALUE ,produces = MediaType.APPLICATION_JSON_VALUE)
    public ResponseEntity<?> updateRecipe(@Schema(example = "400648")@PathVariable(name = "recipe-id")Long recipeId ,
