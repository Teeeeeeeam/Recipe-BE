...
class RecipeLikeServiceImplTest {
    ...
    void Test_Get_User_LikesByPage() {
        ...
        // 테스트 대상 메소드 호출
        UserInfoLikeResponse response = recipeLikeService.getUserLikesByPage(fakeToken,member.getLoginId(),pageable);
    ...
    void No_Valid_User_Approach() {
        ...
        assertThatThrownBy(() -> recipeLikeService.getUserLikesByPage(fakeToken, member.getLoginId(), pageable))
