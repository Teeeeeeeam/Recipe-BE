...
class RecipeLikeServiceImplTest {
    ...
    void add_recipe_like(){
        ...
        Recipe recipe = Recipe.builder().id(3l).recipeContent("content").recipeTitle("title").cookingStep("cookingStep").recipeLevel("recipeLevel").recipeServing("recipeServing")
                .cookingTime("cookingTime").ingredientsAmount("ingredientsAmount").likeCount(0).build();
