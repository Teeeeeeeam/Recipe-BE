...
class CommentServiceImplTest {
    ...
    public void testSave_ValidMemberAndArticle_ReturnsSavedComment() {
        ...
        UserAddCommentRequest commentDto = new UserAddCommentRequest("Test comment", build.getId(), build1.getId(), dateTime);
    ...
    void delete_comment_Test() {
        ...
        UserDeleteCommentRequest commentDto = new UserDeleteCommentRequest(memberDto.getId(), 1l);
    ...
    void delete_comment_by_non_author_Test() {
        ...
        UserDeleteCommentRequest commentDto = new UserDeleteCommentRequest(nonAuthorDto.getId(), 3L);
